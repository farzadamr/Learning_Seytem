...
namespace AdminPanel.EndPoint.Pages.Users.Teacher
{
    public class DeleteModel : PageModel
    {
        ...
        public DeleteModel(ITeacherService teacherService, IPersonService personService)
        {
        ...
        public async Task<IActionResult> OnPostDeleteTeacher()
        {
            if (Teacher.Id == null)
            {
            ...
            var deleteResult = await teacherService.DeleteTeacher(Teacher.Id);
